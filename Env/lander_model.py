...
class Lander_model(object):
    ...
    def get_engagement_keys(self):
        keys = ['t', 'norm_rf', 'norm_vf', 'position', 'velocity', 'attitude', 'attitude_321', 'w', 'thrust', 'bf_thrust', 'torque', 'mass', 'fuel', 'v_ratio','vc', 'reward','fuel_reward','tracking_reward','glideslope_reward', 'landing_margin', 'glideslope', 'sc_margin', 'glideslope_penalty','rh_penalty', 'sc_penalty','sc_reward','att_penalty','att_reward','landing_reward','value','w_reward','w_penalty',  'seeker_angles', 'cs_angles', 'optical_flow', 'theta_cv','fov_penalty','v_err','good_landing']
        return keys
